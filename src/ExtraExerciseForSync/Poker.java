...
//    }
//
//    public static Semaphore sitSix;
//    public static Semaphore zemiKarti;
//
//    public static Semaphore izlezete;
//
//    public static Increment donePlayers = new Increment();
//    public static Increment readyPlayers = new Increment();
//    public static Increment daIzlezam = new Increment();
//
//    public static void init() {
//        sitSix = new Semaphore(6);
//        zemiKarti = new Semaphore(0);
//        izlezete = new Semaphore(0);
//       // dealerGiveCard = new Semaphore(0);
//    }
//
...
//            sitSix.acquire();  //sednuva na masata, kje mu dozvoli samo ako ima pomalku od 6,bidejki max se 6
//            state.playerSeat();
//
//           // natprevar.acquire();
//            readyPlayers.increment(); //ima sporemen igrac
//
//            if (readyPlayers.getCount() == 6){
//                readyPlayers.setCount(0);
//                state.dealCards();
//                zemiKarti.release(6);
//            }
//         //   natprevar.release();
//
//            zemiKarti.acquire();
//            state.play();  //igraat poker
//
//            donePlayers.increment();
//            if (donePlayers.getCount()  == 6){
//                donePlayers.setCount(0);
//                state.endRound();
//              //  natprevar.release();
//                izlezete.release(6);
//            }
...
//            izlezete.acquire();
//            daIzlezam.increment();
//            if (daIzlezam.getCount() == 6){
//                daIzlezam.setCount(0);
//                sitSix.release(6);
//            }
//
//        }
