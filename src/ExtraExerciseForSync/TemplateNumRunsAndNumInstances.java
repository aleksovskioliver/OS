...
//    public static Semaphore wakeUpBerber;
//    public static Semaphore entrySem;
//    public static Semaphore clientHere;
//    public static Semaphore done;
//
//    public static boolean barberSleep = true;
//    public static Increment numClients = new Increment();
//    /**
...
//        wakeUpBerber = new Semaphore(0);
//        entrySem = new Semaphore(0);
//        clientHere = new Semaphore(0);
...
//            clientHere.acquire();
//            state.cutHair();
//            numClients.decrement();
//
//            if (numClients.getCount() == 0) {
//                barberSleep = true;
...
//    }
//
////             berber.acquire();  //bara dozvola da vleze
...
//         */
//        public void execute() throws InterruptedException {
//          //  clients.acquire();  //bara dozvola da vleze
//            state.customerArrived();
//            //clients.release();
//            numClients.increment();
//
//            if (numClients.getCount() == 5 && barberSleep==true){
//                wakeUpBerber.release();
//            }
//            entrySem.acquire();
//            state.customerEntry();
//            clientHere.release();
