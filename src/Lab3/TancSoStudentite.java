...
public class TancSoStudentite {
    ...
    public static Semaphore ZGarderober;
    public static Semaphore MGarderober;
    public static Semaphore sala;
    public static Semaphore slobodnaZhenka;

    public static Increment readyGirls = new Increment();
    public void init() {
        //TODO: da se implementira
    ZGarderober = new Semaphore(10);
    MGarderober = new Semaphore(10);
    sala = new Semaphore(3);
    slobodnaZhenka = new Semaphore(0);
    }
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            MGarderober.acquire();  //bara dozvola za vlez vo gard.dokolku ima pomalku od 10
            show.presobleci();
            MGarderober.release(); //go osloboduva
            if (readyGirls.getCount()>0){
                readyGirls.decrement();

            }
          //  slobodnaZhenka.acquire(); //pobaruva slobodna zhenksa
    ...
    class Zensko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            ...
            show.presobleci();
            ZGarderober.release();
            readyGirls.increment();
         //   slobodnaZhenka.release(); //dava dozvola odnosno spremna e
        }
